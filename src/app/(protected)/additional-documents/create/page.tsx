...
import { AdditionalDocumentFormData } from "@/types/additional-document";
                        ...
                        <div className="text-center space-y-4">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground">
                                    You need to be logged in to create additional documents.
                                </p>
                            </div>
    ...
    return (
        <div className="container mx-auto py-6 space-y-6">
            ...
            <div className="space-y-4">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight">Create New Additional Document</h1>
                    <p className="text-muted-foreground">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Fill in the details for the new additional document
                    </CardDescription>
                </CardHeader>
